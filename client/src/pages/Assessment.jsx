...
function Assessment() {
  ...
  const handleVideoEnd = async () => {
    ...
    try {
      ...
      const response = await api.post("/services/video_questions_transcript", null, {
        params: { transcript: selectedVideo.transcript },
      });
