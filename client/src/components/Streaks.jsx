...
const Streaks = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-black/80 to-black/60 border border-[#B200FF]/30 p-4 rounded-lg shadow-xl shadow-black/40 backdrop-blur-md text-white w-full mx-auto flex flex-col items-center">
      ...
      <div className="flex flex-row overflow-x-auto lg:flex-wrap lg:overflow-x-visible lg:justify-center py-2 space-x-2 lg:space-x-0 lg:gap-x-3 lg:gap-y-4 scrollbar-thin scrollbar-thumb-[#B200FF]/40 scrollbar-track-transparent scrollbar-thumb-rounded-full scrollbar-track-rounded-full w-full">
